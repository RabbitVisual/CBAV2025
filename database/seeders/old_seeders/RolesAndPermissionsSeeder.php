...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Limpar roles e permissions existentes (sem truncate para evitar problemas com foreign keys)
        Role::query()->delete();
        ...
        $roles = [
            'Super Admin' => [
                ...
                'ebd.licoes.access', 'ebd.aulas.access', 'ebd.avaliacoes.access', 'ebd.relatorios.access',
