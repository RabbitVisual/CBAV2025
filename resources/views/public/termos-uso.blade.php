...
@section('title', 'Termos de Uso - ' . \App\Models\Configuracao::get('app_name', 'CBAV CRM'))
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 space-y-8">
            ...
            <section>
                ...
                <p class="text-gray-700 leading-relaxed mb-4">
                    Bem-vindo ao {{ \App\Models\Configuracao::get('app_name', 'CBAV CRM') }}. Estes Termos de Uso regem o uso do nosso sistema de gestão ministerial e estabelecem um acordo legal entre você e nossa organização.
                </p>
            ...
            <section>
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <span class="text-gray-700">Refere-se ao {{ \App\Models\Configuracao::get('app_name', 'CBAV CRM') }} e todos os seus recursos e funcionalidades.</span>
                    </div>
                    <div>
            ...
            <section>
                ...
                <p class="text-gray-700 leading-relaxed">
                    ...
                    <a href="{{ route('politica-privacidade') }}" class="text-blue-600 hover:text-blue-700 underline">Política de Privacidade</a>.
                </p>
            </section>
            ...
            <section>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <p class="text-gray-700"><strong>Email:</strong> {{ \App\Models\Configuracao::get('contact_email', 'contato@cbav.com') }}</p>
                    ...
                    @if(\App\Models\Configuracao::get('address'))
                        <p class="text-gray-700"><strong>Endereço:</strong> {{ \App\Models\Configuracao::get('address') }}</p>
                    @endif
                </div>
            </section>
        </div>
