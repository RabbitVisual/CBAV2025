...
@section('title', 'Validação de Comprovante - ' . \App\Models\Configuracao::get('app_name', 'CBAV'))
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-600">
                Verifique a autenticidade de um comprovante de transação
            </p>
        </div>

        <!-- Formulário de Validação -->
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <form method="GET" action="{{ route('public.validacao.comprovante') }}" class="space-y-6">
                <div>
            ...
            <div class="prose prose-sm text-gray-600">
                ...
                <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                    ...
                    <ul class="text-sm text-blue-800 space-y-1">
                        <li>• Todos os comprovantes emitidos pelo sistema possuem um código único</li>
                        <li>• A verificação é pública e não requer login</li>
