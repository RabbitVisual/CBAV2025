{{-- Componente da Aba Segurança - Configurações do Sistema --}}
<div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            <form action="{{ route('admin.system.settings.update') }}" method="POST" id="form-seguranca">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('session_lifetime') border-red-500 @enderror" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('max_login_attempts') border-red-500 @enderror" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('lockout_duration') border-red-500 @enderror" 
                                   id="lockout_duration" name="lockout_duration" 
                                   value="{{ old('lockout_duration', $configuracoes['lockout_duration'] ?? '15') }}" 
                                   min="1" max="1440">
                        ...
                        <div class="mb-3">
                            <div class="flex items-center mt-4">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="remember_me_enabled" 
                                       ...
                                       {{ old('remember_me_enabled', $configuracoes['remember_me_enabled'] ?? true) ? 'checked' : '' }}>
                ...
                <div class="mb-6">
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="force_https" 
                                       ...
                                       {{ old('force_https', $configuracoes['force_https'] ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="csrf_protection" 
                                       ...
                                       {{ old('csrf_protection', $configuracoes['csrf_protection'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="rate_limiting" 
                                       ...
                                       {{ old('rate_limiting', $configuracoes['rate_limiting'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="ip_whitelist_enabled" 
                                       ...
                                       {{ old('ip_whitelist_enabled', $configuracoes['ip_whitelist_enabled'] ?? false) ? 'checked' : '' }}
                    ...
                    <div class="mt-4" id="ip-whitelist-fields" style="display: {{ old('ip_whitelist_enabled', $configuracoes['ip_whitelist_enabled'] ?? false) ? 'block' : 'none' }};">
                        <label for="admin_ip_whitelist" class="block text-sm font-medium text-gray-700 mb-2">IPs Permitidos (Admin)</label>
                        <textarea class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('admin_ip_whitelist') border-red-500 @enderror" 
                                  id="admin_ip_whitelist" name="admin_ip_whitelist" rows="3" 
                                  placeholder="192.168.1.100&#10;203.0.113.0/24&#10;2001:db8::/32">{{ old('admin_ip_whitelist', $configuracoes['admin_ip_whitelist'] ?? '') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-3">
                        <div class="flex items-center">
                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="two_factor_enabled" 
                                   ...
                                   {{ old('two_factor_enabled', $configuracoes['two_factor_enabled'] ?? false) ? 'checked' : '' }}
                                   onchange="toggle2FA()">
                    ...
                    <div id="two-factor-fields" style="display: {{ old('two_factor_enabled', $configuracoes['two_factor_enabled'] ?? false) ? 'block' : 'none' }};">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-3">
                                <label for="two_factor_method" class="block text-sm font-medium text-gray-700 mb-2">Método de 2FA *</label>
                                <select class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('two_factor_method') border-red-500 @enderror" 
                                        id="two_factor_method" name="two_factor_method">
                                    <option value="">Selecione o método</option>
                                    <option value="totp" {{ old('two_factor_method', $configuracoes['two_factor_method'] ?? '') === 'totp' ? 'selected' : '' }}>TOTP (Google Authenticator, Authy)</option>
                                    <option value="sms" {{ old('two_factor_method', $configuracoes['two_factor_method'] ?? '') === 'sms' ? 'selected' : '' }}>SMS</option>
                                    <option value="email" {{ old('two_factor_method', $configuracoes['two_factor_method'] ?? '') === 'email' ? 'selected' : '' }}>Email</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('two_factor_grace_period') border-red-500 @enderror" 
                                       id="two_factor_grace_period" name="two_factor_grace_period" 
                                       value="{{ old('two_factor_grace_period', $configuracoes['two_factor_grace_period'] ?? '24') }}" 
                                       min="0" max="168">
                                @error('two_factor_grace_period')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <div class="flex items-center">
                                    <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="two_factor_remember_device" 
                                           ...
                                           {{ old('two_factor_remember_device', $configuracoes['two_factor_remember_device'] ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('two_factor_remember_duration') border-red-500 @enderror" 
                                       id="two_factor_remember_duration" name="two_factor_remember_duration" 
                                       value="{{ old('two_factor_remember_duration', $configuracoes['two_factor_remember_duration'] ?? '30') }}" 
                                       min="1" max="365">
                                @error('two_factor_remember_duration')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3 md:col-span-2">
                                <div class="flex items-center">
                                    <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="two_factor_backup_codes" 
                                           ...
                                           {{ old('two_factor_backup_codes', $configuracoes['two_factor_backup_codes'] ?? true) ? 'checked' : '' }}>
                ...
                <div class="mb-6" id="two-factor-info" style="display: {{ old('two_factor_enabled', $configuracoes['two_factor_enabled'] ?? false) ? 'block' : 'none' }};">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('password_min_length') border-red-500 @enderror" 
                                   id="password_min_length" name="password_min_length" 
                                   value="{{ old('password_min_length', $configuracoes['password_min_length'] ?? '8') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('password_expires_days') border-red-500 @enderror" 
                                   id="password_expires_days" name="password_expires_days" 
                                   value="{{ old('password_expires_days', $configuracoes['password_expires_days'] ?? '0') }}" 
                                   min="0" max="365">
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="password_require_uppercase" 
                                       ...
                                       {{ old('password_require_uppercase', $configuracoes['password_require_uppercase'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="password_require_lowercase" 
                                       ...
                                       {{ old('password_require_lowercase', $configuracoes['password_require_lowercase'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="password_require_numbers" 
                                       ...
                                       {{ old('password_require_numbers', $configuracoes['password_require_numbers'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" type="checkbox" id="password_require_symbols" 
                                       ...
                                       {{ old('password_require_symbols', $configuracoes['password_require_symbols'] ?? false) ? 'checked' : '' }}>
...
{{-- Scripts para funcionalidades da aba Segurança --}}
<script>
