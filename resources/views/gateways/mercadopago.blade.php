...
<head>
    ...
    <title>Pagamento via Mercado Pago - {{ config('app.name') }}</title>
...
<body class="bg-gray-50 min-h-screen">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Pagamento via Mercado Pago</h2>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 card-hover">
                ...
                <form id="payment-form" class="space-y-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-3">Informações Pessoais</label>
                    ...
                    <div>
                        ...
                        <div id="payment-method-container" class="space-y-3">
                            <!-- Mercado Pago SDK irá inserir as opções aqui -->
                        </div>
                    </div>

                    <div id="installments-container" class="hidden">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Parcelas</label>
                        <select id="installments" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg">
                ...
                <div class="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-700">Mercado Pago garante a segurança dos seus dados</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center text-gray-500 text-sm">
                <p>Powered by <span class="font-semibold">Mercado Pago</span> • Pagamento seguro e confiável</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const mp = new MercadoPago('{{ $mpKey }}', {
            locale: 'pt-BR'
        });
        ...
        const renderPaymentMethod = async () => {
            const settings = {
                initialization: {
            ...
            const paymentMethod = await bricksBuilder.create('payment', 'payment-method-container', settings);
        };
        ...
        async function processPayment(cardFormData) {
            ...
            try {
                const response = await fetch('/pagamento/mercadopago/processar', {
                    method: 'POST',
                    headers: {
        ...
        function showError(message) {
            ...
            if (!errorElement) {
                ...
                document.getElementById('payment-form').insertBefore(errorElement, document.getElementById('submit-button'));
            }
