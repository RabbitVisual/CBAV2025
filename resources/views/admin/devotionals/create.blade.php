...
@section('title', __('Novo Devocional'))

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">{{ __('Novo Devocional') }}</h1>
            <p class="text-gray-600 mt-2">{{ __('Crie um novo devocional para os membros') }}</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="POST" action="{{ route('admin.devotionals.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="texto_versiculo" 
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="{{ __('O texto do versículo aparecerá aqui quando você buscar um versículo...') }}"
                              readonly>{{ old('texto_versiculo') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="reflexao" 
                              ...
                              rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="{{ __('Digite a reflexão ou oração...') }}">{{ old('reflexao') }}</textarea>
                    @error('reflexao')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
