...
@section('title', 'Nova Lição EBD')

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Nova Lição EBD</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.ebd.licoes.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="duracao_minutos" id="duracao_minutos" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                           value="{{ old('duracao_minutos', 60) }}" min="15" required>
                ...
                <div>
                    ...
                    <input type="text" name="versiculo_chave" id="versiculo_chave" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                           value="{{ old('versiculo_chave') }}" placeholder="Ex: João 3:16">
            ...
            <div class="mt-6">
                ...
                <textarea name="descricao" id="descricao" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Breve descrição da lição...">{{ old('descricao') }}</textarea>
                @error('descricao')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="objetivos" id="objetivos" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Quais são os objetivos desta lição?">{{ old('objetivos') }}</textarea>
                @error('objetivos')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="conteudo" id="conteudo" rows="8"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Conteúdo principal da lição..." required>{{ old('conteudo') }}</textarea>
                @error('conteudo')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="aplicacao_pratica" id="aplicacao_pratica" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Como aplicar esta lição na vida prática?">{{ old('aplicacao_pratica') }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea name="oracao" id="oracao" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Oração relacionada à lição...">{{ old('oracao') }}</textarea>
                @error('oracao')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="material_necessario" id="material_necessario" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Materiais necessários para a lição...">{{ old('material_necessario') }}</textarea>
            ...
            <div class="mt-8 flex justify-end space-x-4">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Criar Lição
                </button>
            </div>
        </form>
    </div>
