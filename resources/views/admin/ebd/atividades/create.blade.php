...
@section('content')
    <div class="flex justify-between items-center mb-2">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Criar Nova Atividade</h1>
    </div>
        ...
        <form action="{{ route('admin.ebd.licoes.atividades.store', $licao) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <x-admin.input name="titulo" id="titulo" value="{{ old('titulo') }}" required />
                ...
                <div class="md:col-span-2">
                    ...
                    <x-admin.textarea name="descricao" id="descricao" rows="5">{{ old('descricao') }}</x-admin.textarea>
                ...
                <div>
                    ...
                    <x-admin.input type="number" name="pontuacao_maxima" id="pontuacao_maxima" value="{{ old('pontuacao_maxima', 10) }}" required />
                ...
                <div>
                    ...
                    <x-admin.input type="date" name="data_entrega" id="data_entrega" value="{{ old('data_entrega') }}" />
