...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Criar Nova Disciplina</h1>
    </div>
        ...
        <form action="{{ route('admin.ebd.disciplinas.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <x-admin.input name="nome" id="nome" value="{{ old('nome') }}" required />
                ...
                <div class="md:col-span-2">
                    ...
                    <x-admin.textarea name="descricao" id="descricao">{{ old('descricao') }}</x-admin.textarea>
                ...
                <div>
                    ...
                    <x-admin.input type="number" name="carga_horaria" id="carga_horaria" value="{{ old('carga_horaria') }}" />
                ...
                <div>
                    ...
                    <x-admin.input name="codigo_disciplina" id="codigo_disciplina" value="{{ old('codigo_disciplina', strtoupper(Str::random(8))) }}" required />
