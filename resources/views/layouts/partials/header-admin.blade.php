                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                            @yield('page-title', 'Vertex CRM')
                        </h1>
                        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium tracking-wide">
                            @yield('page-description', 'CRM Ministerial por Reinan Rodrigues')
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center space-x-6">
            ...
            <div class="hidden md:flex items-center space-x-4">
                <div class="flex items-center space-x-2 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <span
                        class="text-sm font-medium text-blue-900 dark:text-blue-100">{{ \App\Models\User::count() }}</span>
                ...
                <div class="flex items-center space-x-2 px-3 py-2 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    ...
                    <span
                        class="text-sm font-medium text-green-900 dark:text-green-100">{{ $notificacoesNaoLidas }}</span>
            ...
            <div class="relative" x-data="{ profileOpen: false }">
                <button @click="profileOpen = !profileOpen"
                    ...
                    @if ($userPhotoExists)
                        <img src="{{ Storage::url($user->foto) }}?v={{ md5($user->foto . $user->updated_at) }}"
                            alt="{{ $user->name }}" class="w-8 h-8 rounded-full object-cover shadow-lg">
                    @else
                        <div
