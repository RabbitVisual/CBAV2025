...
<?php if(PermissionHelper::canAccessEventos()): ?>
<div class="sidebar-section">
    <!-- Seção Principal -->
    <button @click="toggleSection('eventos')" 
            class="sidebar-item w-full <?php echo e($currentSection === 'eventos' ? 'active' : ''); ?>"
    ...
    <div x-show="expandedSections.eventos && !sidebarCollapsed" 
        ...
        <a href="<?php echo e(route('admin.eventos.index')); ?>" 
           class="sidebar-subitem <?php echo e($currentSubsection === 'eventos' ? 'active' : ''); ?>">
            <i class="sidebar-subitem-icon fas fa-calendar-alt"></i>
            <span class="sidebar-subitem-text">Todos os Eventos</span>
            <?php if($currentSubsection === 'eventos'): ?>
                <div class="sidebar-subitem-indicator"></div>
            <?php endif; ?>
        </a>
        
        <!-- Criar Evento -->
        <a href="<?php echo e(route('admin.eventos.create')); ?>" 
           class="sidebar-subitem <?php echo e($currentSubsection === 'criar' ? 'active' : ''); ?>">
            <i class="sidebar-subitem-icon fas fa-plus-circle"></i>
            <span class="sidebar-subitem-text">Criar Evento</span>
            <?php if($currentSubsection === 'criar'): ?>
                <div class="sidebar-subitem-indicator"></div>
            <?php endif; ?>
        </a>
    </div>
</div>
<?php endif; ?><?php /**PATH C:\wamp64\www\CBAV2025\resources\views/components/admin/sidebar/events.blade.php ENDPATH**/ ?>