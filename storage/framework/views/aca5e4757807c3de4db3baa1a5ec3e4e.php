...
<div id="email">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('admin.system.settings.update')); ?>" method="POST" id="form-email">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="mail_host" name="mail_host" 
                                   value="<?php echo e(old('mail_host', $configuracoes['mail_host'] ?? '')); ?>" 
                                   placeholder="smtp.gmail.com" required
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_host'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="mail_port" name="mail_port" required
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_port'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="25" <?php echo e(old('mail_port', $configuracoes['mail_port'] ?? '') == '25' ? 'selected' : ''); ?>>25 (Padrão - sem criptografia)</option>
                                <option value="465" <?php echo e(old('mail_port', $configuracoes['mail_port'] ?? '') == '465' ? 'selected' : ''); ?>>465 (SSL)</option>
                                <option value="587" <?php echo e(old('mail_port', $configuracoes['mail_port'] ?? '') == '587' ? 'selected' : ''); ?>>587 (TLS) - Recomendado</option>
                                <option value="2525" <?php echo e(old('mail_port', $configuracoes['mail_port'] ?? '') == '2525' ? 'selected' : ''); ?>>2525 (TLS Alternativo)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" id="mail_username" name="mail_username" 
                                   value="<?php echo e(old('mail_username', $configuracoes['mail_username'] ?? '')); ?>" 
                                   placeholder="seu-email@gmail.com" required
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="flex">
                                <input type="password" id="mail_password" name="mail_password" 
                                       value="<?php echo e(old('mail_password', $configuracoes['mail_password'] ?? '')); ?>" 
                                       placeholder="Senha ou App Password" required
                                       class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-l-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="mail_encryption" name="mail_encryption" required
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_encryption'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="tls" <?php echo e(old('mail_encryption', $configuracoes['mail_encryption'] ?? '') === 'tls' ? 'selected' : ''); ?>>TLS (Recomendado)</option>
                                <option value="ssl" <?php echo e(old('mail_encryption', $configuracoes['mail_encryption'] ?? '') === 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                <option value="none" <?php echo e(old('mail_encryption', $configuracoes['mail_encryption'] ?? '') === 'none' ? 'selected' : ''); ?>>Nenhuma</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="mail_from_name" name="mail_from_name" 
                                   value="<?php echo e(old('mail_from_name', $configuracoes['mail_from_name'] ?? config('app.name'))); ?>" 
                                   placeholder="Nome da Empresa" required
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_from_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="mail_timeout" name="mail_timeout" 
                                   value="<?php echo e(old('mail_timeout', $configuracoes['mail_timeout'] ?? '30')); ?>" 
                                   min="10" max="120"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['mail_timeout'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            <div class="flex items-center mt-6">
                                <input type="checkbox" id="mail_verify_peer" name="mail_verify_peer" value="1" 
                                       <?php echo e(old('mail_verify_peer', $configuracoes['mail_verify_peer'] ?? true) ? 'checked' : ''); ?>
...
document.getElementById('btn-test-email').addEventListener('click', function() {
    ...
    fetch('<?php echo e(route("admin.system.settings.test-email")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
</script><?php /**PATH C:\wamp64\www\CBAV2025\resources\views/components/admin/settings/email-tab.blade.php ENDPATH**/ ?>