...
<head>
    ...
    <title><?php echo e(\App\Models\Configuracao::get('app_name', 'CBAV CRM')); ?> - Login</title>
            ...
            <div class="relative z-10 flex flex-col justify-center items-center text-white p-12">
                <div class="text-center max-w-md">
                    <div class="w-24 h-24 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center mb-8 backdrop-blur-sm">
                        <?php if($logo): ?>
                            <img src="<?php echo e(Storage::url($logo)); ?>" alt="Logo <?php echo e($appName); ?>" 
                    ...
                    <h1 class="text-4xl font-bold mb-4"><?php echo e($appName); ?></h1>
                    <p class="text-xl mb-6 text-blue-100"><?php echo e($appDescription); ?></p>
            ...
            <div class="w-full max-w-md space-y-8 animate-fade-in">
                <div class="text-center animate-slide-up">
                    ...
                    <p class="text-gray-600">
                        Acesse o <?php echo e($appDescription); ?>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <div class="text-center">
                            ...
                            <div class="mt-4 flex justify-center space-x-4">
                                <a href="<?php echo e(route('home')); ?>" class="text-blue-600 hover:text-blue-500 text-sm">
                                    <i class="fas fa-home mr-1"></i>Página Inicial
                                </a>
                                <a href="<?php echo e(route('termos-uso')); ?>" class="text-blue-600 hover:text-blue-500 text-sm">
                ...
                <div class="text-center text-sm text-gray-500 animate-slide-up">
                    <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($appName); ?>. Todos os direitos reservados.</p>
...
</html> <?php /**PATH C:\wamp64\www\CBAV2025\resources\views/auth/login.blade.php ENDPATH**/ ?>