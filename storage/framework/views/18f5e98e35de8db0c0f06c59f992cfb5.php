...
?>
<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' || (!localStorage.getItem('darkMode') && window.matchMedia('(prefers-color-scheme: dark)').matches) }" x-init="$watch('darkMode', val => localStorage.setItem('darkMode', val))" :class="{ 'dark': darkMode }">
<head>
    <meta charset="utf-8">
    ...
    <title><?php echo e($appName); ?> - <?php echo e($areaType === 'admin' ? 'Admin' : 'Área do Membro'); ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans antialiased transition-colors duration-200" 
        ...
        <div class="flex h-full flex-col bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-3" x-show="!sidebarCollapsed" x-transition>
                    ...
                    <?php endif; ?>
                    <div>
                        <h1 class="text-gray-900 dark:text-white font-semibold text-sm"><?php echo e(\App\Models\Configuracao::get('app_name', 'CBAV')); ?></h1>
                        <p class="text-gray-500 dark:text-gray-400 text-xs"><?php echo e($areaType === 'admin' ? 'Painel Admin' : 'Área do Membro'); ?></p>
                    </div>
                </div>
            ...
            <nav class="flex-1 overflow-y-auto custom-scrollbar p-4">
                <?php if($areaType === 'admin'): ?>
                    <?php echo $__env->make('layouts.partials.sidebar-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('layouts.partials.sidebar-membro', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            </nav>
                    ...
                    <div class="p-3 bg-gradient-to-r from-primary-50 to-blue-50 dark:from-primary-900/20 dark:to-blue-900/20 rounded-lg border border-primary-100 dark:border-primary-800">
                        ...
                        <div class="space-y-1">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-xs font-medium text-gray-900 dark:text-white"><?php echo e(env('APP_VERSION', '2.0.0')); ?></span>
                            </div>
                    ...
                    <div class="relative group p-2 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-200">
                        ...
                        <div class="tooltip">
                            <div class="text-center">
                                <div class="font-semibold">CBAV v<?php echo e(env('APP_VERSION', '2.0.0')); ?></div>
    ...
    <div class="transition-all duration-300"
        ...
        <!-- Header -->
        <?php if($areaType === 'admin'): ?>
            <?php echo $__env->make('layouts.partials.header-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('layouts.partials.header-member', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
...
</html><?php /**PATH C:\wamp64\www\CBAV2025\resources\views/layouts/app.blade.php ENDPATH**/ ?>