...
<div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('admin.system.settings.update')); ?>" method="POST" id="form-cache-backup">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['cache_driver'];
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="file" <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? 'file') === 'file' ? 'selected' : ''); ?>>File (Arquivo)</option>
                                <option value="redis" <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? '') === 'redis' ? 'selected' : ''); ?>>Redis</option>
                                <option value="memcached" <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? '') === 'memcached' ? 'selected' : ''); ?>>Memcached</option>
                                <option value="database" <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? '') === 'database' ? 'selected' : ''); ?>>Database</option>
                                <option value="array" <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? '') === 'array' ? 'selected' : ''); ?>>Array (Desenvolvimento)</option>
                            </select>
                            <?php $__errorArgs = ['cache_driver'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['cache_default_ttl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('cache_default_ttl', $configuracoes['cache_default_ttl'] ?? '3600')); ?>" 
                                   min="60" max="86400">
                            <?php $__errorArgs = ['cache_default_ttl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="redis-config" class="w-full" style="display: <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? '') === 'redis' ? 'block' : 'none'); ?>;">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="redis_host" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Host Redis</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['redis_host'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('redis_host', $configuracoes['redis_host'] ?? '127.0.0.1')); ?>" 
                                       placeholder="127.0.0.1">
                                <?php $__errorArgs = ['redis_host'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['redis_port'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('redis_port', $configuracoes['redis_port'] ?? '6379')); ?>" 
                                       min="1" max="65535">
                                <?php $__errorArgs = ['redis_port'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <input type="password" class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-l-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['redis_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('redis_password', $configuracoes['redis_password'] ?? '')); ?>" 
                                ...
                                <?php $__errorArgs = ['redis_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['redis_database'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('redis_database', $configuracoes['redis_database'] ?? '0')); ?>" 
                                       min="0" max="15">
                                <?php $__errorArgs = ['redis_database'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="memcached-config" class="w-full" style="display: <?php echo e(old('cache_driver', $configuracoes['cache_driver'] ?? '') === 'memcached' ? 'block' : 'none'); ?>;">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="memcached_host" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Host Memcached</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['memcached_host'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('memcached_host', $configuracoes['memcached_host'] ?? '127.0.0.1')); ?>" 
                                       placeholder="127.0.0.1">
                                <?php $__errorArgs = ['memcached_host'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['memcached_port'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('memcached_port', $configuracoes['memcached_port'] ?? '11211')); ?>" 
                                       min="1" max="65535">
                                <?php $__errorArgs = ['memcached_port'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="cache_enabled" 
                                           ...
                                           <?php echo e(old('cache_enabled', $configuracoes['cache_enabled'] ?? true) ? 'checked' : ''); ?>
                            ...
                            <div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="cache_views" 
                                           ...
                                           <?php echo e(old('cache_views', $configuracoes['cache_views'] ?? true) ? 'checked' : ''); ?>
                            ...
                            <div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="cache_routes" 
                                           ...
                                           <?php echo e(old('cache_routes', $configuracoes['cache_routes'] ?? true) ? 'checked' : ''); ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center mb-2">
                            <input type="checkbox" id="backup_enabled" 
                                   ...
                                   <?php echo e(old('backup_enabled', $configuracoes['backup_enabled'] ?? false) ? 'checked' : ''); ?>
                    ...
                    <div id="backup-config" style="display: <?php echo e(old('backup_enabled', $configuracoes['backup_enabled'] ?? false) ? 'block' : 'none'); ?>;">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <select class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['backup_frequency'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="daily" <?php echo e(old('backup_frequency', $configuracoes['backup_frequency'] ?? '') === 'daily' ? 'selected' : ''); ?>>Diário</option>
                                    <option value="weekly" <?php echo e(old('backup_frequency', $configuracoes['backup_frequency'] ?? '') === 'weekly' ? 'selected' : ''); ?>>Semanal</option>
                                    <option value="monthly" <?php echo e(old('backup_frequency', $configuracoes['backup_frequency'] ?? '') === 'monthly' ? 'selected' : ''); ?>>Mensal</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="time" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['backup_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('backup_time', $configuracoes['backup_time'] ?? '02:00')); ?>">
                                <?php $__errorArgs = ['backup_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['backup_retention_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('backup_retention_days', $configuracoes['backup_retention_days'] ?? '30')); ?>" 
                                       min="1" max="365">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['backup_storage_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('backup_storage_path', $configuracoes['backup_storage_path'] ?? storage_path('app/backups'))); ?>" 
                                       placeholder="<?php echo e(storage_path('app/backups')); ?>">
                                <?php $__errorArgs = ['backup_storage_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <input type="checkbox" id="backup_database" 
                                               ...
                                               <?php echo e(in_array('database', old('backup_items', $configuracoes['backup_items'] ?? ['database', 'files'])) ? 'checked' : ''); ?>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <input type="checkbox" id="backup_files" 
                                               ...
                                               <?php echo e(in_array('files', old('backup_items', $configuracoes['backup_items'] ?? ['database', 'files'])) ? 'checked' : ''); ?>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <input type="checkbox" id="backup_uploads" 
                                               ...
                                               <?php echo e(in_array('uploads', old('backup_items', $configuracoes['backup_items'] ?? ['database', 'files'])) ? 'checked' : ''); ?>
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="backup_compress" 
                                           ...
                                           <?php echo e(old('backup_compress', $configuracoes['backup_compress'] ?? true) ? 'checked' : ''); ?>
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="backup_encrypt" 
                                           ...
                                           <?php echo e(old('backup_encrypt', $configuracoes['backup_encrypt'] ?? false) ? 'checked' : ''); ?>
                        ...
                        <div id="backup-encryption-key" style="display: <?php echo e(old('backup_encrypt', $configuracoes['backup_encrypt'] ?? false) ? 'block' : 'none'); ?>;">
                            ...
                            <div class="flex">
                                <input type="password" class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-l-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['backup_encryption_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('backup_encryption_key', $configuracoes['backup_encryption_key'] ?? '')); ?>" 
                            ...
                            <?php $__errorArgs = ['backup_encryption_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
function testCache() {
    ...
    fetch(`<?php echo e(route('admin.system.cache.test')); ?>`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
function runBackup() {
    if (confirm('Executar backup agora? Esta operação pode demorar alguns minutos.')) {
        ...
        fetch(`<?php echo e(route('admin.system.backup.run')); ?>`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
function listBackups() {
    ...
    fetch(`<?php echo e(route('admin.system.backup.list')); ?>`)
    .then(response => response.json())
    .then(data => {
        if (data.success) {
...
function testBackupConfig() {
    ...
    fetch(`<?php echo e(route('admin.system.backup.test')); ?>`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
function cleanOldBackups() {
    if (confirm('Limpar backups antigos conforme política de retenção?')) {
        fetch(`<?php echo e(route('admin.system.backup.clean')); ?>`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
document.getElementById('form-cache-backup').addEventListener('submit', function(e) {
    ...
    if (cacheDriver !== '<?php echo e($configuracoes["cache_driver"] ?? "file"); ?>') {
        criticalChanges.push('• Alteração do driver de cache');
    }
    
    if (backupEnabled && !<?php echo e(old('backup_enabled', $configuracoes['backup_enabled'] ?? false) ? 'true' : 'false'); ?>) {
...
</script><?php /**PATH C:\wamp64\www\CBAV2025\resources\views/components/admin/settings/cache-backup-tab.blade.php ENDPATH**/ ?>