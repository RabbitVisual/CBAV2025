...
<div id="pagamento">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('admin.system.settings.update')); ?>" method="POST" id="form-pagamento">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" 
                                   ...
                                   <?php echo e(old('stripe_enabled', $configuracoes['stripe_enabled'] ?? false) ? 'checked' : ''); ?>
                    ...
                    <div id="stripe-fields" class="w-full" style="display: <?php echo e(old('stripe_enabled', $configuracoes['stripe_enabled'] ?? false) ? 'block' : 'none'); ?>;">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="stripe_public_key" class="block text-sm font-medium text-gray-700 mb-2">Chave Pública *</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['stripe_public_key'];
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('stripe_public_key', $configuracoes['stripe_public_key'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="password" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['stripe_secret_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('stripe_secret_key', $configuracoes['stripe_secret_key'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <ul class="mb-0 mt-2">
                                        ...
                                        <li>URL do webhook: <code>[Configurar webhook no Stripe]</code></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" 
                                   ...
                                   <?php echo e(old('mercadopago_enabled', $configuracoes['mercadopago_enabled'] ?? false) ? 'checked' : ''); ?>
                    ...
                    <div id="mercadopago-fields" class="w-full" style="display: <?php echo e(old('mercadopago_enabled', $configuracoes['mercadopago_enabled'] ?? false) ? 'block' : 'none'); ?>;">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="mercadopago_public_key" class="block text-sm font-medium text-gray-700 mb-2">Chave Pública *</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['mercadopago_public_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('mercadopago_public_key', $configuracoes['mercadopago_public_key'] ?? '')); ?>" 
                                       placeholder="APP_USR-...">
                                <?php $__errorArgs = ['mercadopago_public_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="password" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['mercadopago_access_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('mercadopago_access_token', $configuracoes['mercadopago_access_token'] ?? '')); ?>" 
                                       placeholder="APP_USR-...">
                                <?php $__errorArgs = ['mercadopago_access_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-blue-700">
                                                <ul class="list-disc list-inside space-y-1">
                                                    ...
                                                    <li>URL do webhook: <code class="bg-blue-100 px-1 rounded">[Configurar webhook no Mercado Pago]</code></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" 
                                   ...
                                   <?php echo e(old('pix_enabled', $configuracoes['pix_enabled'] ?? false) ? 'checked' : ''); ?>
                    ...
                    <div id="pix-fields" class="w-full" style="display: <?php echo e(old('pix_enabled', $configuracoes['pix_enabled'] ?? false) ? 'block' : 'none'); ?>;">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="pix_key" class="block text-sm font-medium text-gray-700 mb-2">Chave PIX *</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['pix_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('pix_key', $configuracoes['pix_key'] ?? '')); ?>" 
                                       placeholder="email@exemplo.com ou CPF/CNPJ">
                                <?php $__errorArgs = ['pix_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['pix_key_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="email" <?php echo e(old('pix_key_type', $configuracoes['pix_key_type'] ?? '') === 'email' ? 'selected' : ''); ?>>Email</option>
                                    <option value="cpf" <?php echo e(old('pix_key_type', $configuracoes['pix_key_type'] ?? '') === 'cpf' ? 'selected' : ''); ?>>CPF</option>
                                    <option value="cnpj" <?php echo e(old('pix_key_type', $configuracoes['pix_key_type'] ?? '') === 'cnpj' ? 'selected' : ''); ?>>CNPJ</option>
                                    <option value="phone" <?php echo e(old('pix_key_type', $configuracoes['pix_key_type'] ?? '') === 'phone' ? 'selected' : ''); ?>>Telefone</option>
                                    <option value="random" <?php echo e(old('pix_key_type', $configuracoes['pix_key_type'] ?? '') === 'random' ? 'selected' : ''); ?>>Chave Aleatória</option>
                                </select>
                                <?php $__errorArgs = ['pix_key_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" 
                                   ...
                                   <?php echo e(old('donations_enabled', $configuracoes['donations_enabled'] ?? false) ? 'checked' : ''); ?>>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        <div>
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['min_donation_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('min_donation_amount', $configuracoes['min_donation_amount'] ?? '5.00')); ?>" 
                                   step="0.01" min="1">
                            <?php $__errorArgs = ['min_donation_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['max_donation_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('max_donation_amount', $configuracoes['max_donation_amount'] ?? '10000.00')); ?>" 
                                   step="0.01" min="1">
                            <?php $__errorArgs = ['max_donation_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['donation_access'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="public" <?php echo e(old('donation_access', $configuracoes['donation_access'] ?? 'public') === 'public' ? 'selected' : ''); ?>>Público (qualquer pessoa)</option>
                            <option value="registered" <?php echo e(old('donation_access', $configuracoes['donation_access'] ?? 'public') === 'registered' ? 'selected' : ''); ?>>Apenas usuários registrados</option>
                            <option value="premium" <?php echo e(old('donation_access', $configuracoes['donation_access'] ?? 'public') === 'premium' ? 'selected' : ''); ?>>Apenas usuários premium</option>
                        </select>
                        <?php $__errorArgs = ['donation_access'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</script><?php /**PATH C:\wamp64\www\CBAV2025\resources\views/components/admin/settings/payment-tab.blade.php ENDPATH**/ ?>